const path = require('path'); // build-in Node module, it generates a path which works either unix and windows systems
const fs = require('fs'); // build-in Node module, fs = file system
